"""
ITN + IRS simulation runner.

Two-step workflow:
  Step 1 (burn-in): set serialization = 1 and serialization_experiment_id = None.
  Step 2 (intervention): set serialization = 0 and serialization_experiment_id to the burn-in id.

Scenarios:
  PBO_only    - PBO-bednet every 3 years, no IRS
  PBO_IRS_yr2 - PBO-bednet every 3 years plus IRS in year 2 of each block
  PBO_IRS_yr3 - PBO-bednet every 3 years plus IRS in year 3 of each block
"""
...
if __name__ == "__main__":
    ...
    serialization = 0
    serialization_experiment_id = '2788cff7-ab76-f111-92e9-000d3af5294c'
